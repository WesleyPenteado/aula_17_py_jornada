...
class Fornecedor(Base):
    ...
    nome = Column(String(50), nullable=False) # nullable indica que o campo é obrigatório
...
engine = create_engine('sqlite:///desafio.db', echo=True) #echo=True para mostrar as operações SQL no console (Debugar)
